...
export function buildMarkdownReport(
  ...
  L.push("# Secure Mail Analysis — Posture Report");
  L.push("");
  ...
  L.push("---");
  L.push("");
  L.push("_Generated by Secure Mail Analysis. Findings are traceable to packet evidence captured in the supplied PCAP; nothing in this report is inferred beyond the captured data._");
  return L.join("\n");
}
